...
class DishInfo{
	...
	public String dishTaste;		//ø⁄Œ∂£∫À·Ãø‡¿±
	public String dishFood;			//÷˜≤ƒ£∫÷Ì»‚£¨∂π∏Ø£¨√Ê∑€£¨º¶»‚
	public String dishCooking;
	public String dishCategory;		//¿‡±£∫ªÁÀÿÃ¿
...
class DishInfoKey{
	...
	public static String dishTaste = "dishTaste";		//ø⁄Œ∂£∫À·Ãø‡¿±
	public static String dishFood = "dishFood";		//÷˜≤ƒ£∫÷Ì»‚£¨∂π∏Ø£¨√Ê∑€£¨º¶»‚
	public static String dishCooking = "dishCooking";
	public static String dishCategory = "dishCategory";		//¿‡±£∫ªÁÀÿÃ¿
