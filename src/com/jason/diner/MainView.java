...
public class MainView extends Fragment {
    ...
    private Fragment ruleFragment;// = new RuleFragment();
...
//		ruleFragment = null;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.main_shop, container, false);
        ...
        public void onPageSelected(int arg0) {
            ...
            case 0:
                if (currIndex == 1) {
                    ...
                    tvTabRule.setTextColor(resources.getColor(R.color.font_color_light));
                }
                tvTabShop.setTextColor(resources.getColor(R.color.font_color_deep));
                break;
            case 1:
                if (currIndex == 0) {
                    animation = new TranslateAnimation(0, position_one, 0, 0);
                    tvTabShop.setTextColor(resources.getColor(R.color.font_color_light));
                }
                tvTabRule.setTextColor(resources.getColor(R.color.font_color_deep));
                break;
            }
            currIndex = arg0;
